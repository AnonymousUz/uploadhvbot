class Translation(object):
    START_TEXT = """Salom @UzDown_Bot ga hush kelibsiz!

<b>Iltimos, menga yuklamoqchi bo'lgan faylingiz yoki videoyingizni ssilkasini yuboring
...
URL | filename | username | password"""
    ...
    DOWNLOAD_START = "<b>Yuklash kutilmoqda.... </b>"
    UPLOAD_START = "<b>yuklanmoqda</b>"
    RCHD_BOT_API_LIMIT = "Aslida telegramga 50mbgacah bolgan fayllarni yuklanadi lekin man sizga 1.5gb gacha bo'lgan fayllarni yuklab beraman."
    RCHD_TG_API_LIMIT = "Downloaded in {} seconds.\nDetected File Size: {}\nShuning botdam maza qilib foydalaning."
